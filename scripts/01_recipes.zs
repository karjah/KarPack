...
recipes.addShaped(<rftools:machine_frame>, [[<minecraft:iron_ingot>, <minecraft:glass>, <minecraft:iron_ingot>],[<minecraft:gold_ingot>, null, <minecraft:gold_ingot>], [<minecraft:iron_ingot>, <minecraft:glass>, <minecraft:iron_ingot>]]);